...
export class AppComponent {
  ...
  confirm(): void {
    const msg = this.populateMessage();
    if (msg) {
      alert(msg);
    }
  ...
  populateMessage(): string {
    ...
    } else if (this.employeesOfSelectedTeam.indexOf(this.employeeSelected) === -1) {
      return 'Please select an employee that belongs to selected team.'
    }
  }
